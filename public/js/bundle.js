...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaWNhcm9tb3R0YSIsImEiOiJja2pyOW12bG4xOXMzMnNrM3NvMzVkM2JlIn0.n0LIYCjkhhmlsxXUD0ydYw';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //EXTEND MAP TO FIT MARKERS
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Account created successfully, please check your email for the account confirmation token');
              window.setTimeout(function () {
                return location.assign('/');
              }, 1000);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"update-user.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: type === 'data' ? '/api/users/UpdateMyAccount' : '/api/users/updatePassword',
              data: data
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Your ".concat(type, " has been updated successfully"));
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"confirmAccount.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/users/confirmEmail/".concat(token)
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Your account was confirmed successfully');
              window.setTimeout(function () {
                return location.assign('/');
              }, 1000);
            }
...
exports.resetPassword = exports.sendRecoveryToken = void 0;
...
function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Your password reset token has been sent to your email successfully");
              window.setTimeout(function () {
                return location.assign('/');
              }, 1000);
            }
  ...
  return function sendRecoveryToken(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.sendRecoveryToken = sendRecoveryToken;
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(password, passwordConfirm, token) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
...
var recoveryForm = document.querySelector('#password-recovery-form');
var resetPassForm = document.querySelector('#reset-password-form');
var userDataForm = document.querySelector('.form-user-data');
var passwordForm = document.querySelector('.form-user-password');
var logoutBtn = document.querySelector('.nav__el--logout');
var emailTokenField = document.querySelector('#email-confirmation-token');
var passwordTokenField = document.querySelector('#password-reset-token'); //DELEGATION
...
if (recoveryForm) {
  recoveryForm.addEventListener('submit', function (e) {
    e.preventDefault();
    (0, _resetPassword.sendRecoveryToken)(document.getElementById('email').value);
  });
}
...
if (resetPassForm) {
  resetPassForm.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password').value;
    var passwordConfirm = document.getElementById('passwordConfirm').value;
    var token = passwordTokenField.getAttribute('token');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              btn = document.querySelector('.btn--data');
              btn.disabled = true;
              btn.textContent = 'Updating...';
              _context.next = 10;
              return (0, _updateUser.updateUser)(form, 'data');
